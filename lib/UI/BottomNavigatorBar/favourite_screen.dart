                ...
                GetBuilder<SongPlayerController>(
                    ...
                    builder: (logic) {
                      return FutureBuilder<GetFavouriteModel>(
                          future: songPlayerController.getfavouriteBookController(userid: userController.userId),
                                                        ...
                                                        onTap: () async {
                                                          await songPlayerController
                                                              .favouriteBookController(
                                                                  postid: snapshot.data!.onlineMp3[index].id, userid: userController.userId)
                                                              .then((val) async => {
